...
def convert_velocity(value, unit):
    if unit == "m/s":
        ...
        return("Unsupported unit for velocity: {}".format(unit))
...
def convert_acceleration(value, unit):
    if unit == "m/s²":
        ...
        return("Unsupported unit for acceleration: {}".format(unit))
...
def motion_type(v, a):
    if v > 0 and a == 0:
        ...
        return("Invalid velocity or acceleration values. Please check your inputs.")
